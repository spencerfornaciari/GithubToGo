...
@interface SFMyRepoTableViewController ()

@property (nonatomic, strong) NSMutableArray *repoArray;

@end

@implementation SFMyRepoTableViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Configure the cell...
    cell.textLabel.text = [self.repoArray[indexPath.row] objectForKey:@"name"];
